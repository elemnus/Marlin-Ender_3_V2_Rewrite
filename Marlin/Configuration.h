 ...
 *   100 : added some custom based on #1 but with offset of +18C due to pin swapping
...
#define TEMP_SENSOR_BED 100 //edit: originally 1 but changed for added offset of +18C
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 309, 415 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -8, -1.28  } //it's weirrd that xyz offset doesnt change, use M851 and save to eeprom

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 0 //edited changed from 15 ; 10-09-2021

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_SPEED (80*60) //edited changed from 60

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_SPEED_FAST (40*60) // edited changed from 4 ; 10-12-2021
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   10 // Z Clearance for Deploy/Stow //edited from 10 ; 10-09-2021
...
#define INVERT_E0_DIR true //edit due to ext wire
...
#define X_BED_SIZE 230 // edited from 220
#define Y_BED_SIZE 230 // edited from 220
...
//
//#define CR10_STOCKDISPLAY //edit 11-14-21
//#define VET6_12864_LCD // or RET6_12864_LCD
...
//
#define DWIN_CREALITY_LCD //edited 11-14-2021, disabled for new 12864lcd
